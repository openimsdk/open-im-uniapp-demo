				...
				<view class="uni-indexed-list__item-container" @click="onClick(idx, index)">
					<view class="uni-indexed-list__item-border"
						...
						<view class="uni-indexed-list__item-content">
							<image :src="item.name.icon||item.name.img" mode="" style="width: 76rpx;
						height: 76rpx;
						border-radius: 76rpx;"></image>
						</view>
						<text class="uni-indexed-list__item-content"style="margin-left: -460rpx;" >{{ item.name.comment||item.name.name }}</text>
					</view>
				</view>
			</view>
		</view>
